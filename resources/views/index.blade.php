...
================================================== -->
   <header> 
   	...
   	<div class="header-logo">
	      <a href="index.html">Samsun Bilgi Güvenliği Zirvesi</a>
	   </div> 
		...
		<nav id="menu-nav-wrap">
			...
			<a href="#0" class="close-button" title="close"><span>Kapat</span></a>	

	   	<h3>Samsun Bilgi Güvenliği Zirvesi</h3>
		   ...
		   <div class="home-content-tablecell">
		   	<div class="row">
		   		<div class="col-twelve">		   			
			  				...
			  				<h3 class="animate-intro">Samsun</h3>
				  			<h1 class="animate-intro">
							Bilgi Güvenliği Zirvesi
				  			</h1>
